...
const PostCard = ({ post }) => {
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/90 md:from-black/80 via-black/20 to-transparent opacity-100 md:opacity-0 group-hover:opacity-100 flex flex-col justify-between p-4">

 {/* Top bar */}
 <div className="flex justify-end translate-y-2 opacity-0 group- group-hover:opacity-100 ">
 {/* <LikeButton initialLikes={post?.likes?.length} post={post} /> */}
 </div>

 {/* Bottom content */}
 <div className="translate-y-4 opacity-0 group- group-hover:opacity-100 delay-75">
