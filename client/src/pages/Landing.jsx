...
const Landing = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-50 dark:bg-[#0a0a0f] overflow-x-hidden flex flex-col relative selection:bg-fuchsia-500/30">
            ...
            <nav className="relative z-50 w-full p-6 flex items-center justify-between max-w-7xl mx-auto backdrop-blur-sm">
                ...
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4">
                    <Link to="/login" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:text-white font-medium transition-colors">Log In</Link>
            ...
            <main className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto w-full pt-16 pb-32 min-h-[90vh]">
                <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col items-center w-full">
                    ...
                    <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl lg:text-8xl font-syne font-extrabold text-gray-900 dark:text-white mb-6 leading-[1.1]">
                    ...
                    <motion.p variants={itemVariants} className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mb-10 leading-relaxed font-medium">
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-20">
                        <Link to="/register" className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-gray-900 dark:text-white font-bold text-lg shadow-lg shadow-violet-600/25 flex items-center justify-center gap-2 hover:scale-105 hover:shadow-violet-500/40 transition-all duration-300">
                            Start Creating <Wand2 className="w-5 h-5" />
                        </Link>
                        <Link to="/login" className="w-full sm:w-auto px-8 py-4 rounded-full glass-card text-gray-900 dark:text-white font-bold text-lg hover:bg-gray-200 dark:bg-white/10 flex items-center justify-center hover:scale-105 transition-all duration-300">
                            Explore Feed
                        </Link>
                    </motion.div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.8, ease: "easeOut" }} className="relative w-full max-w-4xl mx-auto h-64 md:h-96 hidden sm:block mb-10">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[85%] md:w-3/4 h-full glass-card rounded-3xl border border-white/20 shadow-2xl flex flex-col overflow-hidden animate-float z-10 bg-white dark:bg-black/40">
                        <div className="h-12 border-b border-gray-200 dark:border-white/10 flex items-center px-4 gap-2 bg-gray-100 dark:bg-white/5">
                        ...
                        <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center">
                            <div className="absolute inset-0 bg-white dark:bg-black/60 backdrop-blur-sm z-0"></div>
                            ...
                            <div className="glass-card px-4 py-3 md:px-6 md:py-4 rounded-xl flex items-center gap-3 md:gap-4 bg-gray-200 dark:bg-white/10 z-10 transform md:scale-110 border-white/20 backdrop-blur-xl shadow-2xl">
                                <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-fuchsia-400" />
                                <span className="font-mono text-gray-900 dark:text-white text-sm md:text-base">a surreal futuristic city skyline at neon sunset...<span className="animate-pulse font-bold text-fuchsia-400">|</span></span>
                            </div>
                        </div>
                    </div>

                    <motion.div whileHover={{ scale: 1.05, rotate: -2 }} className="absolute top-[15%] -left-4 md:-left-12 w-40 h-40 md:w-56 md:h-56 glass-card rounded-2xl border border-white/20 p-2 animate-float animation-delay-2000 shadow-2xl bg-white dark:bg-black/50 z-20 cursor-pointer">
                    ...
                    <motion.div whileHover={{ scale: 1.05, rotate: 2 }} className="absolute top-[30%] -right-4 md:-right-12 w-48 h-56 md:w-64 md:h-72 glass-card rounded-2xl border border-white/20 p-2 animate-float animation-delay-4000 shadow-2xl bg-white dark:bg-black/50 z-20 cursor-pointer">
            ...
            <section className="relative z-10 py-32 bg-transparent overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col items-center text-center mb-20">
                        ...
                        <h2 className="text-4xl md:text-6xl font-syne font-bold text-gray-900 dark:text-white mb-6">How it <span className="text-fuchsia-400">Works</span></h2>
                        <p className="text-gray-600 dark:text-gray-400 max-w-2xl text-lg">Three simple steps to turn your wildest dreams into digital reality.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        ...
                        {STEPS.map((step, idx) => (
                            ...
                            >
                                <div className={`w-24 h-24 rounded-[2rem] ${step.bg} border border-gray-200 dark:border-white/10 flex items-center justify-center mb-8 relative z-10 group-hover:scale-110 transition-transform duration-500 group-hover:border-white/20 shadow-xl`}>
                                ...
                                <h3 className="text-2xl font-syne font-bold text-gray-900 dark:text-white mb-4">{step.title}</h3>
            ...
            <section className="relative z-10 py-32 bg-transparent text-center px-4">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-6">Create at the Speed of <span className="text-fuchsia-400">Thought</span></h2>
                    <p className="text-gray-600 dark:text-gray-400 text-lg mb-12">Write your prompt, hit generate, and watch magic happen.</p>

                    <div className="glass-card rounded-[2rem] p-4 md:p-8 relative overflow-hidden backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-[0_0_50px_rgba(217,70,239,0.1)]">
                        <div className="flex flex-col md:flex-row items-center gap-4 mb-8 relative z-10">
                            <div className="flex-1 w-full glass-card bg-white dark:bg-black/40 rounded-xl p-4 md:p-6 text-left border-gray-200 dark:border-white/5 flex items-center gap-3">
                                <Sparkles className="text-violet-400 w-6 h-6 shrink-0" />
                                <span className="font-mono text-gray-700 dark:text-gray-300 text-sm md:text-base">
                                    ...
                                    <span className="animate-pulse text-gray-900 dark:text-white">_</span>
                                </span>
                            </div>
                            <button
                                onClick={() => setIsPromptPlaying(true)}
                                className="px-8 py-5 md:py-6 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-gray-900 dark:text-white font-bold flex items-center gap-2 hover:scale-105 active:scale-95 transition-all w-full md:w-auto justify-center"
                            >
                                <Play className="w-5 h-5 fill-white" /> Run
                            </button>
                        </div>

                        <div className="w-full h-48 md:h-[400px] bg-white dark:bg-black/30 rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden relative">
                            {isPromptPlaying ? (
                                <motion.div
            ...
            <section ref={galleryRef} className="relative z-10 py-32 bg-white dark:bg-black/60 border-y border-gray-200 dark:border-white/5 overflow-hidden backdrop-blur-lg">
                <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
                    <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-4">
                        Endless <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-indigo-400">Inspiration</span>
                    </motion.h2>
                    <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
            ...
            <section className="relative z-10 py-24 border-b border-gray-200 dark:border-white/5 bg-white dark:bg-black/20">
                <div className="max-w-7xl mx-auto px-6">
            ...
            <section className="relative z-10 py-24 bg-transparent overflow-hidden">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-syne font-bold text-gray-900 dark:text-white mb-2">Featured Creators</h2>
                    <p className="text-gray-600 dark:text-gray-400">Join thousands of artists making incredible visuals daily</p>
                </div>
                ...
                <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
                    ...
                    >
                        {[...CREATORS, ...CREATORS].map((creator, i) => (
                            <div key={i} className="flex flex-col items-center gap-3 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-4 hover:bg-gray-200 dark:bg-white/10 transition-colors cursor-pointer backdrop-blur-md">
            ...
            <section className="relative z-10 bg-transparent py-32 border-t border-gray-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-4">Powerful <span className="text-violet-400">Features</span></h2>
                        <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto text-lg">Everything you need to create, share, and discover modern AI-generated visuals.</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, delay: 0.1 }} whileHover={{ y: -10 }} className="glass-card p-10 rounded-[2.5rem] relative group overflow-hidden">
                            ...
                            <h3 className="text-2xl font-syne font-bold text-gray-900 dark:text-white mb-4">Generate Instantly</h3>
                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">Simply type your prompt and watch as our models bring your imagination to life in seconds.</p>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, delay: 0.3 }} whileHover={{ y: -10 }} className="glass-card p-10 rounded-[2.5rem] relative group overflow-hidden">
                            ...
                            <h3 className="text-2xl font-syne font-bold text-gray-900 dark:text-white mb-4">Vibrant Community</h3>
                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">Follow creators, discover new styles, and build an audience around your vision.</p>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, delay: 0.5 }} whileHover={{ y: -10 }} className="glass-card p-10 rounded-[2.5rem] relative group overflow-hidden">
                            ...
                            <h3 className="text-2xl font-syne font-bold text-gray-900 dark:text-white mb-4">Curate Collections</h3>
                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">Organize your favorite generations into beautiful public or private moodboards.</p>
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative z-10 py-32 bg-transparent overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <h2 className="text-4xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-20 text-center">Loved by <span className="bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">thousands.</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {TESTIMONIALS.map((t, idx) => (
                            ...
                            >
                                ...
                                <p className="text-gray-700 dark:text-gray-300 italic leading-relaxed">"{t.quote}"</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="relative z-10 py-32 border-t border-gray-200 dark:border-white/10 bg-transparent">
                <div className="max-w-3xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-syne font-bold text-gray-900 dark:text-white mb-4">Frequently Asked Questions</h2>
                    </div>
                        ...
                        {FAQS.map((faq, idx) => (
                            <motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card rounded-2xl overflow-hidden cursor-pointer" onClick={() => setFaqOpen(faqOpen === idx ? null : idx)}>
                                <div className="p-6 flex items-center justify-between">
                                    <h4 className="text-lg font-medium text-gray-900 dark:text-white">{faq.q}</h4>
                                    <motion.div animate={{ rotate: faqOpen === idx ? 90 : 0 }} className="text-gray-600 dark:text-gray-400">
            ...
            <section className="relative z-10 py-32 bg-transparent">
                <div className="max-w-5xl mx-auto px-6">
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="glass-card rounded-[3rem] p-12 text-center relative overflow-hidden border-gray-200 dark:border-white/5"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-4xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-6">Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Revolution</span></h2>
                            <p className="text-gray-600 dark:text-gray-400 text-lg mb-10 max-w-xl mx-auto">Subscribe to our newsletter and get early access to new AI models and community insights.</p>

                            <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
                                <input
                                    type="email"
                                    placeholder="your@email.com"
                                    className="flex-1 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl px-6 py-4 text-gray-900 dark:text-white outline-none focus:border-fuchsia-500/50 focus:bg-gray-200 dark:bg-white/10 transition-all font-medium"
                                />
            ...
            {/* Footer CTA */}
            <motion.footer initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="relative z-10 border-t border-gray-200 dark:border-white/10 bg-white dark:bg-black/80 py-20 flex flex-col items-center justify-center text-center px-4">
                ...
                <h2 className="text-3xl md:text-5xl font-syne font-bold text-gray-900 dark:text-white mb-6">Ready to shape the future?</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-10 max-w-md text-lg">Join Synexis today and start generating incredible art with the power of AI.</p>
