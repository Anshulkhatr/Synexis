...
const AdminPosts = () => {
 ...
 <button onClick={() => handlePublishUnpublishPost(post._id)} className="border border-violet-500/50 text-violet-400 hover:bg-violet-500/10 px-3 py-1 rounded-full text-xs font-medium ">
 Publish
 </button>
 )}
 </td>
