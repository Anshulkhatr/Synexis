...
const AdminUsers = () => {
 ...
 className="w-full bg-white/5 border border-white/10 focus:border-violet-500 rounded-xl py-2 pl-10 pr-4 text-white placeholder-gray-400 focus:outline-none "
 />
 </div>
 </div>
